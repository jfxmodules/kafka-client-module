...
public class SimpleExampleMessageDataJsonConverter {
    public static SimpleExampleMessageData read(JsonNode _node, short _version) {
        ...
        JsonNode _taggedLongFlexibleVersionSubsetNode = _node.get("taggedLongFlexibleVersionSubset");
        if (_taggedLongFlexibleVersionSubsetNode == null) {
            _object.taggedLongFlexibleVersionSubset = 0L;
        } else {
            _object.taggedLongFlexibleVersionSubset = MessageUtil.jsonNodeToLong(_taggedLongFlexibleVersionSubsetNode, "SimpleExampleMessageData");
        }
        ...
        if (_myUint32Node == null) {
            if (_version >= 1) {
                ...
                _object.myUint32 = 1234567;
            }
        } else {
            _object.myUint32 = MessageUtil.jsonNodeToUnsignedInt(_myUint32Node, "SimpleExampleMessageData");
        }
        return _object;
    }
    public static JsonNode write(SimpleExampleMessageData _object, short _version, boolean _serializeRecords) {
        ...
        if (_version >= 2) {
            if (_object.taggedLongFlexibleVersionSubset != 0L) {
                _node.set("taggedLongFlexibleVersionSubset", new LongNode(_object.taggedLongFlexibleVersionSubset));
            }
        }
        ...
        if (_version >= 1) {
            _node.set("myUint32", new LongNode(_object.myUint32));
        } else {
            if (_object.myUint32 != 1234567) {
